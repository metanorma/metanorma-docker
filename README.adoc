...
docker run -v "$PWD":/metanorma metanorma/metanorma metanorma compile iso -x xml,html,doc,pdf iso-8601-2-en.adoc
----
====
...
[source,sh]
----
docker run -v "$PWD":/metanorma/ -w /metanorma metanorma/metanorma metanorma compile {flavor} -x {extensions} {my-document-file}
----
...
[source,sh]
----
docker run -v "%cd%:c:/metanorma" metanorma/metanorma:windows-latest metanorma compile iso document.adoc
----
...
[source,sh]
----
docker run -v "${PWD}:c:/metanorma" metanorma/metanorma:windows-latest metanorma compile iso document.adoc
----
...
[source,sh]
----
docker run --isolation=hyperv -v "%cd%:c:/metanorma" metanorma/metanorma:windows-latest metanorma compile iso document.adoc
----
...
[source,sh]
----
docker run -v "%cd%":/metanorma metanorma/metanorma metanorma compile iso document.adoc
----
...
[source,sh]
----
docker run -v "${PWD}:/metanorma" metanorma/metanorma metanorma compile iso document.adoc
----
...
[source,sh]
----
docker run -v "$PWD":/metanorma:z metanorma/metanorma metanorma compile iso document.adoc
----
...
[source,sh]
----
docker run -v "$PWD":/metanorma my-organization/metanorma:custom metanorma compile iso document.adoc
----
...
[source,sh]
----
make {run,kill,rm,rmf}-metanorma-ruby
----
...
For the `metanorma` flavors, we update using this procedure:
...
[source,sh]
----
make build-metanorma-ruby tag-metanorma-ruby push-metanorma-ruby
----
...
make btp-metanorma-ruby latest-tp-metanorma-ruby
----
