...
VERSIONS    ?= 1.2.10.1 1.2.10.1 1.2.10.1 1.2.10.1
...
ITEMS       ?= 1 2 3 4
IMAGE_TYPES ?= metanorma metanorma-ubuntu mn mn-ubuntu
VERSIONS    ?= 1.2.9 1.2.9 1.2.9 1.2.9
ROOT_PLATFORMS ?= ruby ubuntu ruby ubuntu
...
test-$(3):
	...
	cd mn-samples-iso; $(DOCKER_RUN) -v $(shell pwd)/mn-samples-iso:/metanorma/ $(CONTAINER_LOCAL_NAME) metanorma sources/iso-rice-en.adoc
	$(DOCKER_RUN) $(CONTAINER_LOCAL_NAME) metanorma help
